...
<header id="mainNav" class="navbar-transparent {{ !$isHomepage ? 'navbar-other-page' : '' }} fixed inset-x-0 top-0 z-50 transition-all duration-300">
    <nav class="flex items-center justify-between p-4 sm:p-5 md:p-6 lg:px-8" aria-label="Global">
        ...
        <div class="hidden lg:flex lg:gap-x-12">
            ...
            <a href="{{ $isHomepage ? '#activities' : route('home') . '#activities' }}" class="nav-link text-sm lg:text-base xl:text-lg font-semibold leading-6 transition-all duration-300 text-gray-900 hover:text-brand-pink {{ in_array($currentRoute, ['activities', 'activities.show']) ? 'active' : '' }}" @if($isHomepage) data-scroll-to="activities" @endif>Activities</a>
        ...
        <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
                ...
                <div class="space-y-2 py-6">
                    ...
                    <a href="{{ $isHomepage ? '#activities' : route('home') . '#activities' }}" class="mobile-nav-link -mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 hover:bg-gray-50 transition-all duration-300 {{ in_array($currentRoute, ['activities', 'activities.show']) ? 'active text-brand-pink bg-gray-50' : '' }}" @if($isHomepage) data-scroll-to="activities" @endif>Activities</a>
