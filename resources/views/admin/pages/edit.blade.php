...
<x-page-header
    icon="article"
    title="{{ $page->title }}"
    subtitle="Update page information and settings"
    ...
    <div class="col-12 col-xl-8 mx-auto">
        <form action="{{ route('admin.pages.update', $page) }}" method="POST">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    <x-admin.card title="Edit Page" position="first">
                    ...
                    <x-admin.card title="SEO Settings">
                        <x-admin.form-fieldset legend="Meta Information" mb="mb-2">
                            ...
                            <x-admin.textarea-input
                                ...
                                :filled="!!$page->seo?->meta_description"
                                rows="3"
                                mb="mb-0"
                            />
                        </x-admin.form-fieldset>
                ...
                <div class="col-lg-4">
                    ...
                    <x-admin.card title="Publish" position="first">
                        ...
                        <div class="mb-3">
                            <p class="text-sm mb-0">Created: <strong>{{ $page->created_at->format('d/m/Y') }}</strong></p>
                            <p class="text-sm mb-0">Updated: <strong>{{ $page->updated_at->format('d/m/Y') }}</strong></p>
                        </div>
                            ...
                            <div class="mb-2">
                                <select name="featured_image_id" id="featured_image_id" class="form-control @error('featured_image_id') is-invalid @enderror">
                                    ...
                                    @foreach($media as $image)
                                        <option value="{{ $image->id }}" {{ old('featured_image_id', $page->featured_image_id) == $image->id ? 'selected' : '' }}>
                                            {{ $image->file_name }}
                                        </option>
                                    @endforeach
                                </select>
